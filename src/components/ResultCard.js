...
const ResultCard = ({ result, isVisible }) => {
  ...
  return (
    <div className="result-card">
      ...
      <div className="result-footer">
        <p className="analysis-complete">
          Analysis complete! 🎉
        </p>
        <div className="disclaimer">
          <small>
            * This is a demo with sample data. 
            Real nutrition analysis would require AI/ML integration.
          </small>
        </div>
      </div>
    </div>
